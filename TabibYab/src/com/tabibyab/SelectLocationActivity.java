...
public class SelectLocationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		gMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(Double.parseDouble(getResources().getString(R.string.lat_tehran)),Double.parseDouble(getResources().getString(R.string.lng_tehran))), 11));
